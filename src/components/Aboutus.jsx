	...
	return (
		<div className="fs-5">
			<p>
				...
				planning and strive to provide intuitive, user-friendly
			...
			<p>
				...
				service and support, guiding you every step of the way to
				financial success. With BudgetEase Solutions, you can trust us
				to simplify your finances and pave the way for a brighter
				financial future.
			</p>
		</div>
	);
